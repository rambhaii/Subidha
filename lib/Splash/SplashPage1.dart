...
import 'package:suvidha/Auth/view/Registration.dart';

import '../AppConsTant/textStyle.dart';
import '../Auth/view/LogInPage.dart';
...
class _SplashPage1State extends State<SplashPage1> {
  ...
  login1Route()
  {
    Future.delayed(Duration(seconds: 5)).then((value) =>
        Get.to(()=>Registration(),transition: Transition.fade,duration: Duration(milliseconds: 1000))
    );
  }
